...
while c1 != str('red' or 'blue' or 'yellow'):           # get color 1 input
    c1 = str(input('enter first color to be mixed: '))  # while rejecting 
    if c1 != str('red' or 'blue' or 'yellow'):          # invalid colors.
        print('invalid color.')

while c2 != str('red' or 'blue' or 'yellow'):           # get color 2 input
    c2 = str(input('enter second color to be mixed: ')) # while rejecting
    if c2 != str('red' or 'blue' or 'yellow'):          # invalid colors.
        print('invalid color.')
